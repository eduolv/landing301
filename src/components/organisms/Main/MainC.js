...
import { ButtonPrimaryWhite, ButtonSecondaryWhite } from '@/components/atoms/Buttons';
import { FaInstagram, FaLinkedin } from 'react-icons/fa';

export default function MainC() {
    return (
        <main className="relative min-h-screen flex flex-col items-center justify-center p-6 sm:p-16 -mt-4 bg-[url(/images/back237.png)] bg-cover lg:bg-fixed bg-center bg-no-repeat">
            ...
            <div className="relative container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between z-10 text-white">
                <section className="lg:w-1/2 text-center lg:text-left mb-8 mt-8 lg:mb-0 px-4">
                    ...
                    <section className="absolute bottom-[-80px] sm:bottom-[-110px] left-0 w-full">
                ...
                <div className="lg:w-1/2 flex justify-end mt-18 sm:mt-8 lg:mt-0 pr-4 lg:pr-0">
                    <Image
                        src="/images/back5.svg"
                        alt="Team working on 301 dashboard"
                        width={900} 
                        height={900} 
                        className="object-cover rounded-lg lg:rounded-none lg:object-right"
                        priority={true}
                    />
                </div>
            </div>
